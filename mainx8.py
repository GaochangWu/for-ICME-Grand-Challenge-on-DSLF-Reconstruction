...
result_path = 'Results/' + sceneName + 'x8/'
EVALUATION = 1
ang_res_out = 193
up_scale = 8  # The up scale is fixed, since we use a FROZEN model (Tensorflow),
down_scale = up_scale  # the dimensions of the placeholder are fixed
modelPath1 = "./Model/model_DANx8_1.pb"
modelPath2 = "./Model/model_DANx8_2.pb"  # The two models are exactly the same except for the size of the input placeholder

...
# ----------------- Parameters setting -----------------------
sceneName = 'Development_dataset_3'  # name of the LF
input_path = '../Datasets/ICME/'  # Path to the ICME dataset
result_path = 'Results/' + sceneName + 'x32/'
EVALUATION = 1
ang_res_out = 193
up_scale = 32  # The up scale is fixed, since we use a FROZEN model (Tensorflow),
down_scale = up_scale  # the dimensions of the placeholder are fixed
modelPath1 = "./Model/model_DANx32_1.pb"
modelPath2 = "./Model/model_DANx32_2.pb"
modelPath3 = "./Model/model_DANx32_3.pb"  # The two models are exactly the same except for the size of the input placeholder
